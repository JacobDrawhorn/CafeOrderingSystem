...
using CafeOrderingSystem.Context;
using CafeOrderingSystem.Models;

namespace CafeOrderingSystem.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,OrderName,Quantity,ProductId,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,OrderName,Quantity,ProductId,CustomerId")] Order order)
        {
            if (ModelState.IsValid)
            {
